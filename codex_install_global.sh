...
echo "========================================================"
echo "⚙️  Installing Harness Skills Globally for Codex"
echo "========================================================"
...
for skill_path in "$SKILLS_SRC_DIR"/*; do
    if [ -d "$skill_path" ]; then
        ...
        echo "  ✅ Successfully installed $skill_name for Codex"
    fi
done

echo ""
echo "🎉 Global skills installation for Codex completed successfully!"
echo "The skills are now available globally in Codex ($GLOBAL_SKILLS_DIR)."
echo "========================================================"
