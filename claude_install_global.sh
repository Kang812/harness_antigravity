...
echo "========================================================"
echo "⚙️  Installing Harness Skills Globally for Claude Code"
echo "========================================================"
...
for skill_path in "$SKILLS_SRC_DIR"/*; do
    if [ -d "$skill_path" ]; then
        ...
        echo "  ✅ Successfully installed $skill_name for Claude Code"
    fi
done

echo ""
echo "🎉 Global skills installation for Claude Code completed successfully!"
echo "The skills are now available globally in Claude Code ($GLOBAL_SKILLS_DIR)."
echo "========================================================"
